...
namespace RobbsShoppingCart.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(RobbsShoppingCartContext context, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public async Task<IActionResult> Create(Product product)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["Success"] = "The product is successfully added!";
        ...
        public async Task<IActionResult> Edit(int id, Product product)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["Success"] = "The product is successfully edited!";
